...
class Grafica:
	...
	def dijkstra(self, a):
		"""el algortimo de Dijkstra funciona con las siguentes instrucciones
		...
		6. Seleccionar el nodo no visitado con menor distancia tentativa y marcarlo como el nuevo nodo actual. Se Regresar al punto 3
		"""
...
class main:
	...
	print("\n\nLa ruta más rápida por Dijkstra es (donde [vertice recorrido,distania de las aristas]):")
	g.dijkstra(1)
	print(g.camino(1, 5))
